                                                ...
                                                <div class="Polaris-FormLayout__Item">
                                                    <div class="">
                                                        ...
                                                        <div class="Polaris-Connected">
                                                            <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                                                <div class="Polaris-TextField">
                                                                    <input id="privacyText" autocomplete="email" class="Polaris-TextField__Input" type="text" aria-labelledby=":R2l9n6:Label" aria-invalid="false" value="">
                                                                    <div class="Polaris-TextField__Backdrop">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="fcolor">
                                                                <div>
                                                                    <button class="MuiButtonBase-root MuiButton-root fs-14 MuiButton-sizeSmall MuiButton-disableElevation cls-color color-btn c_btn" tabindex="0" type="button" href="">
                                                                        ...
                                                                        <input type="color" name="global_background_color" value="#beb6b6" id="colorPickerbutton3" class="color_circle">
                                                        ...
                                                        <div class="MuiGrid-root jss197 MuiGrid-item">
                                                            <div class="fcolor">
                                                                <div>
                                                                    <button class="MuiButtonBase-root MuiButton-root fs-14 MuiButton-sizeSmall MuiButton-disableElevation cls-color color-btn c_btn" tabindex="0" type="button" href="">
                                                                        <span class="MuiTouchRipple-root"></span>
                                                                        <input type="color" name="global_background_color" value="#121212" id="bannerTextback" class="color_circle">
                                                        ...
                                                        <div class="MuiGrid-root jss197 MuiGrid-item">
                                                            <div class="fcolor">
                                                                <div>
                                                                    <button class="MuiButtonBase-root MuiButton-root fs-14 MuiButton-sizeSmall MuiButton-disableElevation cls-color color-btn c_btn" tabindex="0" type="button" href="">
                                                                        <span class="MuiTouchRipple-root"></span>
                                                                        <input type="color" name="global_background_color" value="#f60404" id="buttontextcolor" class="color_circle">
                                                        ...
                                                        <div class="MuiGrid-root jss197 MuiGrid-item">
                                                            <div class="fcolor">
                                                                <div>
                                                                    <button class="MuiButtonBase-root MuiButton-root fs-14 MuiButton-sizeSmall MuiButton-disableElevation cls-color color-btn c_btn" tabindex="0" type="button" href="">
                                                                        <span class="MuiTouchRipple-root"></span>
                                                                        <input type="color" name="global_background_color" value="#F9471A" id="buttonbordercolor" class="color_circle">
