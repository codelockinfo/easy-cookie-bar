                    ...
                    <div class="Polaris-Layout__AnnotatedSection">
                        <div class="Polaris-Layout__AnnotationWrapper">
                                        ...
                                        <div role="group" class="Polaris-FormLayout--grouped">
                                            <div class="Polaris-FormLayout__Items">
                                                <div class="Polaris-FormLayout__Item">
                                                    ...
                                                    <div class="Polaris-TextField Polaris-TextField--hasValue"><input id="borderrad" name="myNumber" class="Polaris-TextField__Input" type="number" aria-labelledby="TextField32Label" aria-invalid="false" value="">
                                                        <div class="Polaris-TextField__Spinner" aria-hidden="true">
                            ...
                            <div class="Polaris-Layout__Annotation Polaris-Card polarisboxshadow">
                                <div class="Polaris-TextContainer">
                                    <h2 class="Polaris-Text--root Polaris-Text--headingMd Polaris-Text--headingXl" id="storeDetails">Design Settings</h2>
                                        <div class="Polaris-Box" style="--pc-box-color:var(--p-color-text-subdued)">
