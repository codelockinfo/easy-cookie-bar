                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="Polaris-Choice__Control">
                                                                <span class="Polaris-Checkbox">
                                                                    <input type="checkbox" name="enable_svgicon" class="Polaris-Checkbox__Input" role="checkbox" aria-checked="true" value="1"><span class="Polaris-Checkbox__Backdrop"></span>
                                                                    <span class="Polaris-Checkbox__Icon">
                                                                        <span class="Polaris-Icon">
                                                                        <span class="Polaris-VisuallyHidden"></span>
                                                                        <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="true" aria-hidden="true">
                                                            ...
                                                            <span class="Polaris-Choice__Label">Enable Cookie SVG</span>
                                                            </label>
                                                        </div>
                                                    </div>
