                          ...
                          if(comeback.outcome.showon == 1){
                            ...
                            initCookieBanner();
                                ...
                                '<a class="cc-dismiss handleAccept allow" style="padding:7px 15px;color:'+ comeback.outcome.color_button_text +'; background-color:'+  comeback.outcome.color_button  +'; border-color: '+  comeback.outcome.color_button_border  +';border-radius:'+  comeback.outcome.button_border_radius  +';border:'+ comeback.outcome.border  +';">'+ comeback.outcome.decline_text +'</a>'+
                                    '<a class="cc-dismiss handleDecline deny" style="margin-left: 0.5em;padding:7px 15px;color:'+ comeback.outcome.color_button_text +'; background-color:'+  comeback.outcome.color_button  +'; border-color: '+  comeback.outcome.color_button_border  +';border-radius:'+  comeback.outcome.button_border_radius  +';border:'+ comeback.outcome.border  +';">'+ comeback.outcome.agreement_text +'</a>'+
                                '</div>'+
