        ...
        function  cookiesbarSettingSelect(){
            $.ajax({
              ...
              success: function(comeback) {
                ...
                $("body").append('<style>.CookiesBar_IconSvg {fill:'+comeback.outcome.color_button+';}.cc-dismiss{ display: flex;align-items: center;justify-content: center;height: 45px;width: 160px;cursor: pointer;}.three{display: flex;gap: 10px;justify-content: center;margin-right: 25px;margin-left: 30px;}.bar-text-wrapper{display: flex;flex-direction: column;justify-content: center;flex: 5;padding: 5px;}.cookie_svg{width: 45px;margin: 36px 20px 20px 27px;}.displayflex{display:flex;}.modal_preview{position: absolute;}.modal_preview .cc-close{position: absolute;top: 10px;right: 10px;cursor: pointer;position: absolute;top: 10px;right: 10px;}.preview_set{height:'+  height +'px;display: flex;justify-content: space-between;}.preview_set .cc-close{cursor: pointer;margin-left: 0.5em;font-size: 20px;font-weight: 700;position: absolute;top: 10px;right: 10px;}.preview_set .seven{flex: 1 1 auto;}.modal_preview .three{width: 100%;text-align: center;}.modal_preview{width: 500px;flex-wrap: wrap;}.modal-wrapper.open{visibility: visible;opacity: 1;}.modal-wrapper{display: flex;z-index: 999;width: 100%;height: 100%;visibility: hidden;top: 0;left: 0;opacity: 0;filter: alpha(opacity=0);-webkit-transition: all 0.3s ease-in-out;-moz-transition: all 0.3s ease-in-out;-o-transition: all 0.3s ease-in-out;transition: all 0.3s ease-in-out;}@media(max-width:1200px){.preview_set .seven{width: 65%;}.preview_set .three{width: 35%;text-align: end;}}@media(max-width:768px){.modal_preview{width:100%;}.cookie_svg{width:100%;display: flex;margin:0;justify-content: center;padding-top: 15px;}.preview_set{display: block;height:auto}.preview_set .seven{width: 100%;}.preview_set .three{width: 90%;text-align: end;}}</style>'+
